...
## Project Structure
    ...
    ├── homefieldtest_dev_22864  # Django project configurations
...
1. Clone this repo and `cd homefieldtest_dev_22864`
...
2. Clone this repo and `cd homefieldtest_dev_22864`
